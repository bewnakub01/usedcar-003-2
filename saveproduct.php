<?php 
    ...
    if(!in_array($fileType[1],$allowedType)){
        ...
        $sqlInsert = "INSERT INTO car (brand,model,modelYear,color,license,province,price,postedBy,postedDate,carpic)VALUES('$brand','$model','$modelyear','$color','$license','$province','$price','$postby',NOW(),'$filename')";
